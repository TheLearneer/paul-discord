...
class RawMessageReactionAddEvent extends Piece {
	...
	async run(data) {
		...
		await this.client.events.get('messageReactionAdd').run(reaction, user);
	}

}

module.exports = RawMessageReactionAddEvent;
